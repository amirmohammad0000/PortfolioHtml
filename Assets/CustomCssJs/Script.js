...
function progress_bar() {
    ...
    let div_progress_sect_1_11 = document.querySelector(".div_progress_sect_1_11");
    let div_progress_sect_1_12 = document.querySelector(".div_progress_sect_1_12");
    ...
    let div_progress_sect_2_11 = document.querySelector(".div_progress_sect_2_11");
    let div_progress_sect_2_12 = document.querySelector(".div_progress_sect_2_12");
    ...
    div_progress_sect_1_11.style.width = "0%";
    div_progress_sect_1_12.style.width = "0%";
    ...
    div_progress_sect_2_11.style.width = "0%";
    div_progress_sect_2_12.style.width = "0%";
    ...
    if (document.documentElement.scrollTop >= 1300 || document.body.scrollTop >= 1300) {
        ...
        div_progress_sect_1_9.style.width = "60%";
        div_progress_sect_1_10.style.width = "80%";
        div_progress_sect_1_11.style.width = "70%";
        div_progress_sect_1_12.style.width = "60%";
        ...
        div_progress_sect_2_10.style.width = "90%";
        div_progress_sect_2_11.style.width = "60%";
        div_progress_sect_2_12.style.width = "70%";
        ...
        div_progress_sect_1_11.style.transition = "width 2s ease-in-out";
        div_progress_sect_1_12.style.transition = "width 2s ease-in-out";
        ...
        div_progress_sect_2_11.style.transition = "width 2s ease-in-out";
        div_progress_sect_2_12.style.transition = "width 2s ease-in-out";
    }
}
...
setTimeout(() => {
    ...
    let setint_3 = setInterval(() => {
        h2.innerHTML = "من";
        div_text_animate.innerHTML = "Mobile Application Developer";
        h1.appendChild(div_text_animate);
        clearInterval(setint_3);
    }, 15000);


    let setint_4 = setInterval(() => {
        h2.innerHTML = "من";
        div_text_animate.innerHTML = "Desktop Application Developer";
        h1.appendChild(div_text_animate);
        clearInterval(setint_4);
    }, 21000);


    let setint_5 = setInterval(() => {
        h2.innerHTML = "من";
        div_text_animate.innerHTML = "Web Application Developer";
        h1.appendChild(div_text_animate);
        clearInterval(setint_5);
    }, 27000);


    let setint_6 = setInterval(() => {
        h2.innerHTML = "سلام من";
        h1.innerHTML = "Amir Mohammad Koshkian";
        clearInterval(setint_6);
    }, 33000);
}, 100)
/****************************************//* End Animate Text */